...
library(readr)
mod <- read.csv("Rubber_Durian_Pinang - Copy.csv", header = TRUE, sep = ",")
...
first_decision_function <- function(x, varnames) {
  ...
  # Calculate rubber monoculture system cost
  ...
  # Benefit land clearing rubber from wood harvesting
  ...
  # Equipment cost including depreciation each component
  ...
  # chilli and Cassava at first year, Banana at the second year of system
  ...
  # Calculate NPV Rubber-Areca catechu and Durio zibethinus
...
second_decision_function <- function(x, varnames) {
  ...
  # Benefit land clearing rubber from wood harvesting after land clearing
  benefit.land.clearing.rubber[1] <- vv(benefit_land_clearing, var_CV, 1)
  benefit.land.clearing.rubber[2:n_years] <- 0
  ...
  # Calculate Total Rubber Monoculture Benefit
  ...
  # Benefit Rubber-Archidendron jiring and Parkia speciosa 
...
third_decision_function <- function(x, varnames) {
  ...
  # Sondrium k. yield at the end of life cycle (wood)
  ...
  # Total Rubber monoculture benefit
  ...
  # Total benefit Rubber-Archidendron jiring - Sondrium k.
  ...
  # Benefit of choosing Rubber-Archidendron jiringa-Sondrium k. over rubber monoculture
...
estimate <- estimate_read_csv("Rubber_Durian_Pinang - Copy.csv")
...
```{r echo=TRUE, warning=FALSE, fig.cap="**Graph. 1 Cashflow Rubber Pinang Durian**"}
...
```{r echo=TRUE, warning=FALSE, fig.cap="**Graph. 2. CashflowRubber Petai Jengkol**",}
...
```{r echo=TRUE, warning=FALSE,  fig.cap="**Graph. 3. Cashflow Rubber Archidendron jiringa and Sandoricum koetjape**"}
...
```{r echo=TRUE, warning=FALSE, fig.cap="**Graph. 4. Cashflow Rubber Mono**",}
plot_cashflow(mcSimulation_object = mcSimulation_result2,
              color_25_75 = "yellow3",
              color_5_95 = "khaki",
              color_median = "blue",
...
knitr::include_graphics("rubber mono.jpg", error = FALSE)
```

## NPV Comparisson

### NPV Rubber monoculture vs Rubber-Areca catechu and Durio zibethinus
```{r echo=TRUE, warning=FALSE, fig.cap="**Graph. 5. NPV Comparrion Rubber-Areca-Durian with Rubber Mono**",}
...
```{r echo=TRUE, warning=FALSE, fig.cap="**Graph. 6. NPV Comparrion Rubber-Archidendron-Parkia with Rubber Mono**",}
...
```{r echo=TRUE, warning=FALSE, fig.cap="**Graph. 7. NPV Comparrion Rubber-Archidendron-Sondrium with Rubber Mono**",}
