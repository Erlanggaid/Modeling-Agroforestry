...
#### Model Function 1 (Rice Monoculture vs Rice-Areca nut-Coconut-Maize along the dike)
...
first_decision_function <- function(x, varnames) {
  ...
  # seedling cost Areca nut (Pinang)
...
#### Model Function 2 (Rice Monoculture vs Rice-Areca nut-Maize along the dike)
```{r}
library(decisionSupport)
...
second_decision_function <- function(x, varnames) {
  ...
  # Land clearing rice excluding family labour
  land.clearing.rice.efl[1:n_years] <- vv(clearing_cost_rice_nfl, CV_cost, n_years)
  
  # Fertilizing cost rice excluding family labour
  fertilizing.cost.rice.efl[1:n_years] <- vv(fertilizing_cost_rice_nfl, CV_cost, n_years)
  
  # Planting cost rice excluding family labour
  planting.cost.rice.efl[1:n_years] <- vv(planting_cost_rice_nfl, CV_cost, n_years)
  ...
  #Total Benefit Rice (Family Labour is excluded in the calculation)
  total_rice_benefit.efl <- ((tot_rice_benefit - seedling.cost.rice - 
                              land.clearing.rice.efl - herbicide.cost.rice - 
                              fertilizer.cost.rice - harvest.cost.rice - 
                              planting.cost.rice.efl - plowing.cost.rice - 
  ...
  AF_maize_costs <- vv(maize_cost, var_CV, n_years)
  
  AF_maize_benefit <- (AF_maize_revenue-AF_maize_costs)*2
  
  # Calculate the NPV of rice agroforestry
  ...
  tradeoff_benefit.fl <- NPV_rice_pn.efl - NPV_rice.efl
...
```{r echo=TRUE, fig.cap="**Graph. 1 Cashflow Rice-Coconut-Areca nut-Maize (Excluding Family Labour Calculation)**"}
...
```{r echo=TRUE, fig.cap="**Graph 2. Cashflow Rice-Areca nut-Maize (Excluding Family Labour Calculation)**",}
...
```{r echo=TRUE, fig.cap="**Graph. 3 Cashflow Rice Mono culture (Excluding Family Labour Calculation**",}
plot_cashflow(mcSimulation_object = mcSimulation_result1, 
              color_25_75 = "grey60",
              color_5_95 = "grey80",
              color_median = "blue",
...
```{r echo=TRUE, warning=FALSE, fig.cap="**Graph. 4 NPV comparison Rice-Coconut-Areca nut-Maize and Rice Monoculture (Excluding Family Labour Calculation)**",}
decisionSupport::plot_distributions(mcSimulation_object = mcSimulation_result1, 
                                    vars = c("rice.efl_NPV", "rice_ccpn.efl_NPV"),
                                    method = 'smooth_simple_overlay', 
                                    bins = 150,
                                    old_names = NULL,
                                    new_names = NULL,
                                    colors = c("darkgreen","greenyellow"),
                                    outlier_shape = ".",
...
```{r echo=TRUE, warning=FALSE, fig.cap="**Graph. 5 NPV comparison Rice-Areca nut-Maize and Rice Monoculture (Excluding Family Labour Calculation)**", warning=FALSE}
decisionSupport::plot_distributions(mcSimulation_object = mcSimulation_result2, 
                                    vars = c("rice_pn.efl_NPV", "rice.efl_NPV"),
                                    method = 'smooth_simple_overlay', 
                                    bins = 150,
                                    old_names = NULL,
                                    new_names = NULL,
...
```{r echo=TRUE, warning=FALSE, fig.cap="**Graph. 6 Tradeoff Rice-Coconut-Areca nut-Maize over Rice Monoculture (Excluding Family Labour Calculation)**"}
decisionSupport::plot_distributions(mcSimulation_object = mcSimulation_result1, 
                                    vars = "trade_off_FL",
                                    method = 'boxplot',
                                    colors = "greenyellow",
...
```{r echo=TRUE, warning=FALSE, fig.cap="**Graph. 7 Tradeoff Rice-Areca nut-Maize over Rice Monoculture (Excluding Family Labour Calculation)**", warning=FALSE}
decisionSupport::plot_distributions(mcSimulation_object = mcSimulation_result2, 
                                    vars = "trade_off_FL",
                                    method = 'boxplot',
                                    old_names = "trade_off_FL",
                                    new_names = "Tradeoff Family Labour",
                                    colors = "khaki2",
                                    outlier_shape = 3)
```
...
# plot EVPI
plot_evpi(evpi, decision_vars = "trade_off_FL", base_size = 8)
```
...
# plot EVPI
plot_evpi(evpi2, decision_vars = "trade_off_FL", base_size = 14)
```
