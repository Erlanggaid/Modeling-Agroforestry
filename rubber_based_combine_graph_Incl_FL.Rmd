...
first_decision_function <- function(x, varnames) {
  ...
  tradeoff_benefit1 <- NPV_rb_ag - NPV_rb
  
  #  Benefit of choosing Rubber-Archidendron jiring and Parkia speciosa over rubber monoculture
  tradeoff_benefit2 <- NPV_rb_ag2 - NPV_rb
  
  # Benefit of choosing Rubber-Archidendron jiringa-Sandoricum k. over rubber monoculture
  tradeoff_benefit3 <- NPV_rb_ag3 - NPV_rb
  
  # Final NPV of the decision to choose
  NPV_tradeoff1 <- discount(tradeoff_benefit1, discount_rate = discount_rate, calculate_NPV = TRUE)

  NPV_tradeoff2 <- discount(tradeoff_benefit2, discount_rate = discount_rate, calculate_NPV = TRUE)
  
  NPV_tradeoff3 <- discount(tradeoff_benefit3, discount_rate = discount_rate, calculate_NPV = TRUE)
  
  # In the return list, one can indicate any outcome they wish to see from the model
  return(list(trade_off1 = NPV_tradeoff1,
              trade_off2 = NPV_tradeoff2,
              trade_off3 = NPV_tradeoff3,
              rb_ag_NPV = NPV_rb_ag,
...
### Plot cash flow Rubber-Areca palm-Durian
```{r echo=TRUE, warning=FALSE, fig.cap="**Graph. 1 Cash flow Rubber-Areca palm-Durian**"}
...
```{r echo=TRUE, warning=FALSE, fig.cap="**Graph. 2. Cash flow Rubber-jengkol-petai**",}
plot_cashflow(mcSimulation_object = mcSimulation_result1,
                        color_25_75 = "bisque2",
                        color_5_95 = "bisque",
                        color_median = "blue",
...
```{r echo=TRUE, warning=FALSE,  fig.cap="**Graph. 3. Cash flow Rubber-jengkol-koetjape**"}
plot_cashflow(mcSimulation_object = mcSimulation_result1,
                        color_25_75 = "plum",
                        color_5_95 = "plum1",
                        color_median = "blue",
...
decisionSupport::plot_distributions(mcSimulation_object = mcSimulation_result1, 
                                    vars = c("rb_NPV", "rb_ag_NPV", "rb_ag2_NPV","rb_ag3_NPV"),
                                    method = 'smooth_simple_overlay', 
                                    bins = 150,
                                    old_names = NULL,
                                    new_names = NULL,
                                    colors = c( "darkorange2", "springgreen4", "mediumorchid3","darkolivegreen2"),
                                    outlier_shape = ".",
...
decisionSupport::plot_distributions(mcSimulation_object = mcSimulation_result1, 
                                    vars = c("trade_off1", "trade_off2", "trade_off3"),
                                    method = 'boxplot',
