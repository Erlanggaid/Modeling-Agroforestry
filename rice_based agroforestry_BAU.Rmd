...
#### Model Function 1 (Rice Monoculture vs Rice-Coconut-Areca nut-Maize along the dike)
...
second_decision_function <- function(x, varnames) {
  ...
  # Calculate the NPV of rice agro forestry
...
```{r echo=TRUE, fig.cap="**Graph. 1 Cashflow Rice-Coconut-areca nut-maize**", warning=FALSE}
...
```{r echo=TRUE, fig.cap="**Graph. 2 Cashflow Rice-areca nut-maize**", warning=FALSE}
...
```{r echo=TRUE, fig.cap= "**Graph 3. Cashflow Rice Monoculture**", warning=FALSE}
plot_cashflow(mcSimulation_object = mcSimulation_result1, 
              color_25_75 = "grey60",
              color_5_95 = "grey80",
              color_median = "blue",
...
```{r echo=TRUE, warning=FALSE, fig.cap="**Graph. 4 NPV comparison Rice-Coconut-areca nut-maize and Rice Monoculture**", }
...
```{r echo=TRUE, warning=FALSE, fig.cap="**Graph. 5 NPV comparison Rice-areca nut-maize and Rice Monoculture**", warning=FALSE}
...
```{r echo=TRUE, warning=FALSE, fig.cap="**Graph. 6 Tradeoff Rice-Coconut-areca nut-maize over Rice Monoculture**"}
decisionSupport::plot_distributions(mcSimulation_object = mcSimulation_result1, 
                                    vars = "trade_off",
                                    old_names = "trade_off",
                                    new_names = "Tradeoff",
...
```{r echo=TRUE, warning=FALSE, fig.cap="**Graph. 7 Tradeoff Rice-areca nut-maize over Rice Monoculture**", warning=FALSE}
decisionSupport::plot_distributions(mcSimulation_object = mcSimulation_result2, 
                                    vars = "trade_off",
                                    method = 'boxplot',
                                    old_names = "trade_off",
